...
urlpatterns = [
    ...
    path('v1/assets/', include('assets.urls', namespace='assets')),
    path('v1/webhooks/', include('webhooks.urls', namespace='webhooks')),
    path('v1/protected/', include('protected.urls', namespace='protected')),
]
